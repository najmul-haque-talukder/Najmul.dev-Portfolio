...
const Home = () => {
  return (
    <div>
      {/* Main Sections */}
      <div
        className="-translate-y-25 relative w-full min-h-screen max-h-[1000px]"
      ...
      <div className="absolute top-50 right-1/2 translate-x-1/2 text-white  ">
        <div className="flex gap-2 items-center justify-center text-center text-white pb-5 sm:flex-col md:flex-col lg:flex xl:flex">
        ...
        <div className="text-white flex gap-5 pt-10 items-center justify-center">
          <button className="bg-white text-black px-5 py-2 rounded-full hover:scale-101 duration-500 hover:bg-white/80">
            <a
          ...
          <button className="border border-gray-200 rounded-full px-5 py-2">
            <a
