...
const Home = () => {
  return (
    ...
    //   {/* Main Content */}
    //   <div className="-translate-y-25 w-full bg-gray-950">
    //     <div className="bg-cover w-full h-screen h-base">
    //         <DarkVeil />
    //     </div>
    //     <Section2 />
    //     <Section3 />
    ...
    //   {/* Navbar */}
    //   <div className="absolute -top-20 px-30 sm:px-10 left-0 w-full z-10">
    //     <Header />
    //   </div>

    //   {/* Hero Section */}
    //   <div className="absolute top-10 left-1/2 transform -translate-x-1/2 z-20 w-full px-4 md:px-0">
